...
La fonte di verità è **`_build/COPY_GUIDE.md` §1** (tabella con prezzi, anchor e cart-permalink verificati). Nota v2 (metal-first): sul sito restano SOLO 3 prodotti — Metalworking Project Plans **$37** (`/cart/58091624431919:1`), Metal Cut-File Vault **$19** (`/cart/58142503076143:1`), Commercial License **$19** (`/cart/58133406679343:1`). I bundle restano sullo store Shopify ma non sul sito. Quando un prezzo o un variant ID cambia sullo store:
